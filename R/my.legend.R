...
##' line.
##' @param end.pch if \code{TRUE}, add the point characters specified by
##' \code{pch} to both end points of the legend lines specified by
##' \code{lty}. Defaults to \code{FALSE} which reproduces the base behaviour.
